    ...
    return (
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mt-6">
            ...
            <div className="space-y-6">
                {cart.items.map((item) => (
                    <div key={item.product._id} className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-50 pb-6 group">
                        ...
                        <div className="flex items-center space-x-6 mt-4 sm:mt-0 w-full sm:w-auto justify-between sm:justify-end">
                            <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                                <button 
                                    ...
                                    className="px-4 py-2 bg-gray-50 text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors"
                                >-</button>
                            ...
                            <button 
                                ...
                                className="text-red-400 hover:text-red-600 font-medium p-2"
                            >
                                Remove
                            </button>
                        </div>
            ...
            <div className="mt-10 bg-gray-50 p-6 rounded-xl flex flex-col sm:flex-row justify-between items-center">
                ...
                <button 
                    onClick={checkout}
                    className="mt-6 sm:mt-0 bg-gray-900 text-white px-10 py-4 rounded-xl font-bold hover:bg-gray-800 shadow-md transition-colors w-full sm:w-auto"
                >
                    Proceed to Checkout
                </button>
            </div>
