...
const AddProduct = () => {
    ...
    // Heavily expanded dummy data with strict, verified image matching
    const dummyData = {
        'Mobiles': [
        ...
        'Women\'s Clothing': [
            ...
            { name: 'Knit Sweater', brand: 'Everlane', price: '85.00', countInStock: '120', imageUrl: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?q=80&w=800&auto=format&fit=crop', attributes: { 'Size': 'Large', 'Fabric': 'Merino Wool', 'Style': 'Cozy', 'Color': 'Cream', 'Occasion': 'Casual / Winter' } }
        ],
        'Shoes': [
            ...
            { name: 'Ultraboost 1.0', brand: 'Adidas', price: '190.00', countInStock: '50', imageUrl: 'https://images.unsplash.com/photo-1518002171953-a080ee817801?q=80&w=800&auto=format&fit=crop', attributes: { 'Size': 'US 9.5', 'Material': 'Primeknit', 'Sole': 'Boost Foam', 'Color': 'Core Black', 'Style': 'Running' } },
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dummyList = dummyData[safeSubCategory]; 
            const randomPick = dummyList[Math.floor(Math.random() * dummyList.length)];
            
            const uniqueVariantId = Math.floor(Math.random() * 9000) + 1000;
            
            const finalName = formData.name.trim() || `${randomPick.name} - Var ${uniqueVariantId}`;
